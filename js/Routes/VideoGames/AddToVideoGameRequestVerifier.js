...
module.exports = (req, res, next) => {
    try {
        if (isEmpty(req.body.title) || isEmpty(req.body.day) || isEmpty(req.body.month) ||
            isEmpty(req.body.year) || isEmpty(req.body.image_provider) || isEmpty(req.body.image_url) 
            || isEmpty(req.body.referrer_name) || isEmpty(req.body.genre) || isEmpty(req.body.platform) ) {
