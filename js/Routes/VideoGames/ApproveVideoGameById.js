...
const ApproveVideoGameRouter = express.Router();
...
ApproveVideoGameRouter.post("/api/videogame/approve", tokenVerifier, tokenAuthCheck, videoGameIdVerifier, function (req, res) {
	try {
...
module.exports = ApproveVideoGameRouter;
