...
MarkBikeForRecheckRouter.post('/api/bike/mark_recheck', tokenVerifier, tokenAuthCheck, bikeIdVerifier, function (req, res) {
    try{
        jwt.verify(req.token, process.env.key, function (error, authData) {
            if (error) {
                ...
                if (!authData['privilages'].includes('bikes')) {
                    ...
                    try {
                        var id = req.body._id;
                        bikeDAO.markForRecheckById(id, function (status, message, data) {
...
module.exports = MarkBikeForRecheckRouter;
