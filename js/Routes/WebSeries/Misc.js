...
webSeriesMiscRouter.post('/api/webSeries/inc/:id', function (req, res) {
...
webSeriesMiscRouter.post('/api/webSeries/partners', function (req, res) {
    try {
...
webSeriesMiscRouter.post('/api/webSeries/languages', function (req, res) {
    try {
