...
const uncheckedWebSeriesRouter = express.Router();
        ...
        jwt.verify(req.token, process.env.key, function (error, authData) {
            if (error) {
                ...
                if (!authData['privilages'].includes('webSeries')) {
                    ...
                    try {
                        webSeriesDAOForRetrieval.getAllUnchecked(function (status, message, data) {
...
module.exports = uncheckedWebSeriesRouter;
